            ...
            <div class="row">
                        ...
                        <div class="mb-2">
                            <div class="form-outline mb-3" style="width: 100%; max-width: 22rem">
                                ...
                                <input type="text" id="phone" class="form-control"
                                    data-mdb-input-mask="+48 999-999-999" / name="phoneNumber"
                                    placeholder="+34 123 456 789" required="true">
                            </div>
                        </div>
                        <div class="mb-2">
                ...
                <div class="col">
                    <div class="card m-2 p-2">
                        ...
                        <select class="form-select mb-2" onchange="calculatePresupuesto()" id="productType" name="productType" required="true">
                        ...
                        <div class="d-flex border rounded flex-column p-2 mb-2">
                            ...
                            <form class="text-center">
                                <div class="form-group">
                                    ...
                                    <input class="form-range" type="range" min="1" max="8" step="1" value="8"
                                        id="nbWeeks" name="nbWeeks" oninput="calculatePresupuesto()">
                    ...
                    crossorigin="anonymous">
                        ...
                        <div class="card p-2" style="width: 18rem;">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch"
                                    id="switchDedicatedServer" name="switchDedicatedServer"
                                    onchange="calculatePresupuesto()">
                                <label class="form-check-label" for="flexSwitchCheckDefault">Dedicated
                                    server (100€)</label>
                            </div>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch"
                                    id="switchDomainName" name="switchDomainName"
                                    onchange="calculatePresupuesto()">
                        ...
                        <div class="p-3 text-warning-emphasis bg-warning-subtle border border-warning-subtle rounded-3" id="presupuestoTotal"></div>
                    </div>
                </div>
            </div>
            <div class="row">
